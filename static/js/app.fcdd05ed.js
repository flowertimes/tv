			...
			var i = a("2b0e"),
				...
				o = function() {
					var t = this,
						...
						a = t._self._c || s;
					return a("div", {
						class: "container valentine block load " + (t.enterValentine ?
							"valentine-enter" : "")
					}, [a("div", {
						...
						class: "old-tv " + (t.tvOn && !t.showMessage ? "load" : t
							.offAnimation ? "off off-animation" : "off")
					}, [a("div", {
					...
					._e(), t.playbackRate >
						...
						class: (t.showPayCode ? "fadein-enter-active" :
							"fadein-leave-active") + " modal paycode",
				...
				p = {
					...
					created: function() {
						...
						d.a.get("".concat(s, "/info")).then((function(s) {
							...
							s.data && s.data.length > 0 && (t.mediaList = s.data, t
								.setupPlayer())
						})).catch((function(t) {
							console.log(t)
						}))
					...
					methods: {
						...
						toggleTV: function() {
							if (!this.showMessage && null != this.player) {
								if (this.tvOn = !this.tvOn, this.tvOn) {
									var t = Math.floor(Math.random() * this.firstSource.length);
									this.playerPlay(this.firstSource[t].src, 1e3)
								} else this.offAnimation = !0, this.player.pause();
								var s = new Audio(
									"https://cdn.jsdelivr.net/gh/knob16/resource@1.2/static/media/switch.mp3"
									);
								s.play()
							}
						},
						...
						onRateChange: function(t) {
							null != this.player && (this.playbackRate = t.target.value, this.player
								.playbackRate(t.target.value))
						},
						onShowPayCode: function(t) {
							null != this.info && (this.qrcode = "left" === t ? this.info
								.qrcode_on_left : this.info.qrcode, this.showPayCode = !0)
						},
						openActivity: function() {
							if (null != this.player) {
								this.player.pause(), this.enterValentine = !0, this.tvOn = !0;
						...
						closeActivity: function() {
							...
							t.play(), this.tvOn = !1, this.player.pause(), this.enterValentine = !1
						},
						playerPlay: function(t, s) {
							var a = this;
							this.player.src(t), this.playbackRate = 1, this.player.playbackRate(1), this
								.showMessage = !0, console.log(this.player), setTimeout((function() {
									console.log("timeout"), a.showMessage = !1, a.player.play()
								}), s)
						}
					}
				},
				...
				C = b,
				g = (a("034f"), Object(f["a"])(C, c, n, !1, null, null, null)),
				y = g.exports;
			a("b20f");
			i["a"].prototype.$video = e["a"], i["a"].config.productionTip = !1, new i["a"]({
				render: function(t) {
					return t(y)
				}
			}).$mount("#app")
